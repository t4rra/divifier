function divify({target ="div", consoleMsg=true}={}) {
  if (consoleMsg) {
    ...
    console.log(
      "this pawge was mawde with divifier.js, quwite possibwy the wowst js fwamewowk to exist"
    );
    console.log(
      "u can awso code with awll divs at https://github.com/eaaasun/divifier!"
    );
  }
